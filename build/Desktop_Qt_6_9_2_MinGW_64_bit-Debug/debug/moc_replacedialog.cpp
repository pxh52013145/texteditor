...
template <> constexpr inline auto ReplaceDialog::qt_create_metaobjectdata<qt_meta_tag_ZN13ReplaceDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'replaceOne'
        QtMocHelpers::SignalData<void(const QString &, const QString &, QTextDocument::FindFlags)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
// SIGNAL 0
void ReplaceDialog::replaceOne(const QString & _t1, const QString & _t2, QTextDocument::FindFlags _t3)
{
